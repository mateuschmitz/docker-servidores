...
RUN apt-get install -y mysql-server php5 php5-mysql php5-mcrypt apache2 vim git php5-dev libpcre3-dev build-essential net-tools wget sudo openssh-server proftpd
